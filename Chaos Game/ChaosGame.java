...
class ChaosGame implements KeyListener {
	...
	ChaosGame() {
		...
		view2 = new FPSView(simple, canvas);
		...
		view.lookAt(new Point3d(10, 10, 15), new Point3d(0, 0, 0), new Vector3d(0, 1, 0));
		view.invert();
	...
	public void change(double x, double y, double z) {
		...
		/*
		 * rand = (int)(Math.random()*100);//generates a random number to decide which
		 * case is called
		 * 
		 * switch(rand) {
		 * 
		 * case 0: { x+=2;//changes A change of fractal for x y+=3;//changes A change of
		 * fractal for y z+=1;//changes A change of fractal for z break; }//end case 0
		 * 
		 * case 1: { x+=(int)(-.70*x);//changes B change of fractal for x
		 * y+=(int)(-.80*y);//changes B change of fractal for y
		 * z+=(int)(-.20*z);//changes B change of fractal for z break; }//end case 1
		 * 
		 * case 2: { x+=(int)(1);//changes C change of fractal for x
		 * y+=(int)(-1);//changes C change of fractal for y z+=(int)(1);//changes C
		 * change of fractal for z break; }//end case 2 }//end of switch
		 */
	...
	public static void main(String args[]) {
		ChaosGame g = new ChaosGame();
	}// end of main()
}// end of class ChaosGame