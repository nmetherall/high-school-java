...
class Star
{
	...
	private double G = 6.67300E-11;//Universal gravitational constant
	...
	void update(ArrayList<Star> list)
	{
		...
		for(Star s : list)//goes through the array list of stars and calculates the gravitational force beetween each one and this star
		{
			...
			f = (G * m * s.m) / d;//gravitational attraction
			a = f / m;//total acceleration
	...
	public void move(ArrayList<Star> list)
	{
	...
	public void combine(ArrayList<Star> list, Star s)
	{
