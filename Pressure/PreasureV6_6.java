...
class PreasureV6_6 implements MouseListener,ActionListener
{
	double force[][];
	int weight[][];
	boolean pos[][],pauseC;
...
//	double sizeW2;
	...
	PreasureV6_6()
	{
		...
		frame = new JFrame("Preasure V6_6");
	...
	void doubleBuffer()
	{
		try
		{
			if(pauseC == true)threadMain.sleep(1000);
			else{}
		}
	...
	{
		PreasureV6_6 s = new PreasureV6_6();
	}//end of main
